...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tsflex-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13317&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tsflex-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tsflex` can be installed with:

```
conda install tsflex
```

It is possible to list all of the versions of `tsflex` available on your platform with:
